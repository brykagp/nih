...
//   return (
//     <div className="fixed bottom-5 right-5 w-96 bg-gray-900 text-white shadow-lg p-4 rounded-lg">
//       {/* Chatbot Header with Buttons */}
...
//       {/* Chat Messages */}
//       <div className="h-56 overflow-y-auto border border-gray-700 p-3 rounded-lg bg-gray-800 space-y-2">
...
//         <input
//           className="flex-1 p-2 border border-gray-700 rounded-lg bg-gray-800 text-white outline-none focus:ring-2 focus:ring-blue-500"
